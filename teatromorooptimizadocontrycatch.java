...
public class teatromorooptimizado {
    ...
    private static final int CAPACIDAD_TEATRO = 250;//Número máximo de entradas
    ...
    public static void main(String[] args) { //inicio del programa
        ...
        do {
            ...
            System.out.println("4. Detalle de la compra / Salir");
            ...
            try {
                ...
                System.out.println("Ingrese solo numeros y que estos esten presente en el menu");
                scanner.nextLine();
                opcion = 0;
            }
        } while (opcion != 4);
    ...
    private static void comprarEntrada() {
            ...
            try {
                ...
                switch (opcionAsiento) {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        System.out.println("Opcion de asiento no valida. Por favor, seleccione nuevamente.");
                        continue;
                }
            } catch (InputMismatchException e) {
                System.out.println("Opcion de asiento no valida. Por favor, seleccione nuevamente.");
        ...
        int precioBase = obtenerPrecioBase(opcionAsiento);
    ...
    private static int obtenerPrecioBase(int opcionAsiento) {
        switch (opcionAsiento) {
            case 1:
                return PRECIO_VIP;
            case 2:
    ...
    private static void eliminarVenta() {
        ...
        try {
            ...
            eliminarVenta(); // Volver a llamar al método para que el usuario vuelva a intentar eliminar una venta
        }
    }
    ...
    private static void actualizarVenta() {
        ...
        int idVentaActualizar;

        while (true) {
            try {
                idVentaActualizar = scanner.nextInt();
